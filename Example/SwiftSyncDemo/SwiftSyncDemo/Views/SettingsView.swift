    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section {
                    Link(destination: URL(string: "https://github.com/jomaw0/SwiftSync-swift")!) {
                        HStack {
                            Image(systemName: "link")
                                .foregroundColor(.blue)
                                .frame(width: 24)
                            Text("SwiftSync on GitHub")
                            Spacer()
    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 24) {
                ...
                Text("This app demonstrates the capabilities of SwiftSync, a comprehensive, type-safe SQLite Object-Relational Mapping framework for Swift.")
                    .font(.body)
